...
(* Sets the bits of V between First and Last to the least significant
   bits of Value.    *)
...
(* Sets the bit of V (whose type is long) indicated by Position
   to Value (false or true)   *)

procedure SetBitsL (var V:long; First, Last:byte; Value:long);
(* Sets the bits of V (whose type is long) between First and Last to
   the least significant bits of Value  *)
...
function GetBits( V:word; FirstBit, LastBit:byte ) : word ;
(* Returns a substring of bits between FirstBit and LastBit
   from V whose type is word *)
(* Ex:                    1111 11                          *)
...
function GetBitsL( V:long; FirstBit, LastBit:byte ) : long ;
(* Returns a substring of bits between FirstBit and LastBit from V whose
   type is long *)
begin
...
procedure SetBitsL( var V:long; First, Last:byte; Value:long ) ;
(* Sets the bits of V (whose type is long) between First and Last to the
